#ifndef _hmltm_RCPP_HELLO_WORLD_H
#define _hmltm_RCPP_HELLO_WORLD_H
...
RcppExport SEXP hmltm_get_tfm(SEXP Istype, SEXP Iv);

RcppExport SEXP hmltm_get_invtfm(SEXP Istype, SEXP Iv);
